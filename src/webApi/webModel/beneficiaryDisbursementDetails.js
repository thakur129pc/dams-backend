...
const beneficiarDisbursementDetailsSchema = new mongoose.Schema({
    bhumiPrice: {
        type: Number,
        required: true
    },
...
const beneficiarDisbursementDetails = mongoose.model('beneficiarDisbursementDetails', beneficiarDisbursementDetailsSchema);
export default beneficiarDisbursementDetails;
