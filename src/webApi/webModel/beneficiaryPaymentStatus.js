...
const beneficiaryPaymentSchema = new mongoose.Schema({
    ...
    disbursementId: { type: mongoose.Schema.Types.ObjectId, ref: 'beneficiarDisbursementDetails', required: true },
    userId: { type: mongoose.Schema.Types.ObjectId, ref: 'User' }

})
const beneficiaryPaymentStatus = mongoose.model('beneficiaryPaymentStatus', beneficiaryPaymentSchema);
