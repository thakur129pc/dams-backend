...
import { createBeneficiaryQuery, createDisbursementDetails, disbursePage, getAllBeneficiaries, getAllBeneficiariesPaymentStatus, getAllbeneficiaryDisburmentlist, verifyBeneficiaryDetails} from '../webController/beneficiaryController.js';
...
router.post('/add-query',requireAuth,createBeneficiaryQuery)
